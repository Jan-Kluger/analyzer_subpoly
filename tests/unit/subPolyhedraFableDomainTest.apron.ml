...
module D = SubPolyhedraFableDomain.D
...
let test ?(count=100) name = Test.make ~count ~long_factor:10 ~name:("subpoly_fable: " ^ name)
...
module VM = SubPolyhedraFableDomain.VarManagement
module P = VM.P
module RI = RationalintervalFable.RationalInterval
...
let test () =
  "subPolyhedraFableDomain" >::: explore_example5 :: QCheck_ounit.to_ounit2_test_list tests
