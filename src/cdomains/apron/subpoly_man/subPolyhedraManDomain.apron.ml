...
module M = Messages
open GobApron
open SubPolyhedraManCore

module Mpqf = SharedFunctions.Mpqf
module RationalInterval = RationalintervalMan.RationalInterval
...
*)
  ...
  **************)
  ...
  let invariant _t = failwith "SubPolyhedraManDomain.invariant:   not implemented"
